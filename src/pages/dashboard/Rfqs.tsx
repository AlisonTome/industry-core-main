...
import { useLocal, K, Rfq, Proposal, newId, pushNotification } from "@/lib/store";
...
export default function Rfqs() {
  ...
  function createRfq(data: Record<string, FormDataEntryValue>) {
    ...
    setRfqs([next, ...rfqs]);
    pushNotification({ title: "RFQ criada", body: `${id} — ${next.part}`, type: "info" });
  ...
  return (
    <>
      <PageHeader
        title={isSupplier ? "RFQs abertas" : "Cotações (RFQ)"}
        description={isSupplier ? "Consulte solicitações compatíveis e envie propostas técnicas." : "Crie, acompanhe e adjudique solicitações de cotação."}
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>Preencha os dados técnicos. Você poderá anexar desenhos depois.</DialogDescription>
          </DialogHeader>
